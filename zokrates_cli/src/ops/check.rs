...
use zokrates_field::{Bls12_377Field, Bls12_381Field, Bn128Field, Bw6_761Field, Secp256k1Field, Field};
...
pub fn exec(sub_matches: &ArgMatches) -> Result<(), String> {
    ...
    match curve {
        CurveParameter::Secp256k1 => cli_check::<Secp256k1Field>(sub_matches),
